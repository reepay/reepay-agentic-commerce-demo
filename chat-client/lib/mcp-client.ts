...
export async function initializeMCPClients(
  ...
  for (const mcpServer of mcpServers) {
    try {
      ...
      // Debug: Log the full tool schema for lookup_items
      if (mcptools.lookup_items) {
        console.log('lookup_items tool schema:', JSON.stringify(mcptools.lookup_items, null, 2));
      }
